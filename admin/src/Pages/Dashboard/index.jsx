...
import LineChartUsersAndSales from "../../components/Recharts";
...
const Dashboard = () => {
  ...
  return (
    <>
      <div
        className="w-full bg-[#f1faff] p-5 mb-5 border border-[rgba(0,0,0,0.1)] rounded-md
            flex items-center justify-between gap-8"
      >
        <div className="info">
          <h1 className="text-[35px] font-bold leading-10 mb-3">
            Good Morning, <br /> Eren
          </h1>
          <p>
      ...
      <div className="card my-6 shadow-md sm:rounded-lg bg-white">
        <div className="flex items-center justify-between p-5">
          <h2 className="text-[18px] font-[600]">Recent Orders</h2>
        </div>

        <div class="relative overflow-x-auto mt-2 pb-5">
              ...
              <tr class="bg-white dark:bg-gray-800">
                ...
                <td className="px-6 py-4">
                  <span className="font-[500] block w-[400px]">
                    H No 222 Street No 6 Nghia Thinh Nghia Hung Nam Dinh Viet
                    Nam. +80-798236432
                  </span>
                </td>
                <td className="px-6 py-4">
