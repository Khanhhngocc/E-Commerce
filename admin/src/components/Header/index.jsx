    ...
    <header className="w-full h-auto py-2 pl-80 pr-7 bg-[#fff] shadow-md flex items-center justify-between">
      ...
      <div className="part2 w-[40%] flex items-center justify-end gap-5">
        ...
        <div className="relative">
          ...
          >
            <img
              src="https://openclipart.org/image/800px/283776"
          ...
          >
            <MenuItem onClick={handleCloseMyAcc} className="!bg-white">
              <div className="flex items-center gap-3">
                ...
                <div className="info">
                    <h3 className="text-[15px] font-[500] leading-4">Eren Yeager</h3>
                    <p className="text-[12px] font-[400] opacity-70">eren.yeager.rumbling@gmail.com</p>
                </div>
              </div>
            </MenuItem>
            <Divider />
