                    ...
                    <div className="col3 w-[30%] flex items-center pl-7">
                        <ul className="flex items-center gap-3 justify-end w-full">
                            <li>
                                ...
                                <Link to={"/register"} className="link transform text-[15px] font-[500]">Register</Link>
                            </li>

                            <li>
                                <Tooltip title="Compare">
                                    <IconButton aria-label="cart">
                                        <StyledBadge StyledBadge badgeContent={4} color="secondary">
                                            <IoIosGitCompare />
                                        </StyledBadge>
                                    </IconButton>
                                </Tooltip>
                            ...
                            <li>
                                <Tooltip title="Cart">
                                {/* <Tooltip title="Cart" placement="top"></Tooltip> */}
                                    <IconButton aria-label="cart">
                                        <StyledBadge StyledBadge badgeContent={4} color="secondary">
